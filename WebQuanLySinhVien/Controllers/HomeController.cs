...
namespace WebQuanLySinhVien.Controllers
{
    public class HomeController : Controller
    {
        ...
        // ============================================================
        // CÁC HÀM QUẢN LÝ LỚP, MÔN HỌC, ĐIỂM (Giữ nguyên như cũ)
        // ============================================================
        ...
        public IActionResult ThemLop(string malop, string tenlop, string makh)
        {
            ...
            try
            {
                SqlParameter[] p = { new SqlParameter("@MALOP", malop), new SqlParameter("@TENLOP", tenlop), new SqlParameter("@MAKH", makh) };
        ...
        public IActionResult ThemMonHoc(string mamh, string tenmh, string makh)
        {
            ...
            try
            {
                SqlParameter[] p = { new SqlParameter("@MAMH", mamh), new SqlParameter("@TENMH", tenmh), new SqlParameter("@MAKH", makh) };
        ...
        public IActionResult ThemDiem(string masv, string mamh, double diemso)
        {
            ...
            try
            {
                SqlParameter[] p = { new SqlParameter("@MASV", masv), new SqlParameter("@MAMH", mamh), new SqlParameter("@DIEM", diemso) };
